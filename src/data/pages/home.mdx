...
description: "VERITIR is the safe intermediary between university research labs and foundation models—so models can learn from high-value research work without labs relinquishing custody, IP, or publication freedom."
---
...
import NegationList from '../../components/NegationList.astro';
import TrustPrinciples from '../../components/TrustPrinciples.astro';
...
>
  <p class="text-lg font-medium text-accent">VERITIR turns these shadow assets into governed, revenue-generating data products.</p>
</Section>
...
<Section title="Turn research artifacts into governed, licensable data products.">
  <Cards>
    <Card
...
<Section id="how" title="How it works">
  <Steps>
    <Step n={1} title="Identify" description="Surface the high-value research artifacts that sit outside patents and papers: datasets with metadata, outcome labels, negative results, protocols." />
    <Step n={2} title="Package" description="Structure raw lab outputs into governed data products—benchmarks, evaluation sets, fine-tuning packs—with clear rights, provenance, and permitted-use terms." />
    <Step n={3} title="Connect" description="Match packaged assets to qualified buyers: AI labs seeking domain evaluation, pharma needing model validation, device companies building specialized models." />
    <Step n={4} title="Earn & iterate" description="Generate recurring revenue through benchmark subscriptions, licensed access, and sponsored evaluations. Audit trails prove compliance at every step." />
  </Steps>
</Section>
